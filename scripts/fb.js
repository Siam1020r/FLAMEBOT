...
𖤍 Profile URL: 🥀${userInfo[uid].profileUrl}🥀\ 
𖤍 Gender: 🔥${genderText}🔥\
𖤍 User Type: 👑${userInfo[uid].type}👑\ 
𖤍 Is Friend: 💸${userInfo[uid].isFriend ? "Yes" : "No"}💸\ 
𖤍 Is Birthday today: 💦${userInfo[uid].isBirthday ? "Yes" : "No"}💦`;
