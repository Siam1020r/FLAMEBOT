  ...
  onStart: async function ({ api, event, args }) {
    ...
    try {
      ...
      if (participants.includes(event.senderID)) {
        api.sendMessage("『✍︎ 🥷𝘛'𝘦𝘴 𝘥𝘦𝘫𝘢 𝘥𝘢𝘯𝘴 𝘭𝘦 𝘨𝘳𝘰𝘶𝘱𝘦 𝘴𝘪 𝘵𝘶 𝘵𝘳𝘰𝘶𝘷𝘦𝘴 𝘱𝘢𝘴 𝘷𝘦𝘳𝘪𝘧𝘪𝘦 𝘵𝘢 𝘣𝘰𝘪𝘵𝘦 𝘥𝘦 𝘮𝘦𝘴𝘴𝘢𝘨𝘦𝘴 𝘦𝘵 𝘴𝘱𝘢𝘮 ✍︎』", event.threadID);
      ...
      api.sendMessage("🙎🏽 | ❌Non une erreur s'est produite ❌   🥷réessaye 🥷", event.threadID);
